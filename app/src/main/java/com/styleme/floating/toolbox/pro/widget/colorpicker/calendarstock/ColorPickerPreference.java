 ...
 * under the License. *****************************************************************************
 */
package com.styleme.floating.toolbox.pro.widget.colorpicker.calendarstock;
...
public class ColorPickerPreference extends Preference {
    ...
    protected void onClick() {
        ...
        ColorPickerDialog colorcalendar = (ColorPickerDialog) ColorPickerDialog.newInstance(R.string.color_picker_default_title,
                mColorChoices, getValue(), mNumColumns, AppHelper.isTablet(getContext()) ? ColorPickerDialog.SIZE_LARGE : ColorPickerDialog
                        .SIZE_SMALL);
    ...
    protected void onAttachedToActivity() {
        ...
        Activity activity = (Activity) getContext();
        ColorPickerDialog colorcalendar = (ColorPickerDialog) activity.getFragmentManager().findFragmentByTag(getFragmentTag());
