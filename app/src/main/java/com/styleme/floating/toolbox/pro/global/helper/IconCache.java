...
public class IconCache {
    ...
    private void loadIconPack() {
        ...
        String iconPack = AppHelper.getIconPack(mContext);
    ...
    static Bitmap createIconBitmap(Drawable icon, Context context, Drawable iconBack, Drawable iconMask, Drawable iconUpon, float scale) {
        synchronized (sCanvas) { // we share the statics :-(
            if (sIconWidth == -1) {
                initStatics(context);
            }
